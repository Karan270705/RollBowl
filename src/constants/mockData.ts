...
export const MOCK_ORDERS: Order[] = [
  { id: 'ord-1', orderNumber: 'RB-1001', userId: 'user-1', customerName: 'Rohan Sharma', stallId: 'stall-1', stallName: 'RollBowl Main Kitchen', items: [makeItem('oi-1','meal-1','Paneer Tikka Bowl',1,149), makeItem('oi-2','meal-7','Cold Coffee',2,69)], status: OrderStatus.PREPARING, orderType: OrderType.PRE_ORDER, paymentStatus: PaymentStatus.PAID, subtotal: 287, tax: 14, discount: 0, total: 301, createdAt: '2026-05-14T09:30:00Z', updatedAt: '2026-05-14T09:35:00Z', estimatedReadyTime: '2026-05-14T09:50:00Z', pickupDate: '2026-05-14' },
  ...
  { id: 'ord-3', orderNumber: 'RB-1003', userId: 'user-3', customerName: 'Amit Kumar', stallId: 'stall-2', stallName: 'Campus Bites', items: [makeItem('oi-4','meal-3','Masala Dosa',1,89), makeItem('oi-5','meal-5','Egg Bhurji Pav',1,79)], status: OrderStatus.READY, orderType: OrderType.PRE_ORDER, paymentStatus: PaymentStatus.PAID, subtotal: 168, tax: 8, discount: 0, total: 176, createdAt: '2026-05-14T08:15:00Z', updatedAt: '2026-05-14T08:40:00Z', pickupDate: '2026-05-14' },
  { id: 'ord-4', orderNumber: 'RB-1004', userId: 'user-4', customerName: 'Sneha Desai', stallId: 'stall-1', stallName: 'RollBowl Main Kitchen', items: [makeItem('oi-6','meal-2','Chicken Shawarma Roll',2,129), makeItem('oi-7','meal-12','Masala Chai',2,29)], status: OrderStatus.CONFIRMED, orderType: OrderType.SUBSCRIPTION, paymentStatus: PaymentStatus.PAID, subtotal: 316, tax: 16, discount: 50, total: 282, createdAt: '2026-05-14T10:00:00Z', updatedAt: '2026-05-14T10:02:00Z', pickupDate: '2026-05-14' },
  { id: 'ord-5', orderNumber: 'RB-1005', userId: 'user-1', customerName: 'Rohan Sharma', stallId: 'stall-3', stallName: 'Green Bowl Express', items: [makeItem('oi-8','meal-4','Vegan Buddha Bowl',1,169)], status: OrderStatus.DELIVERED, orderType: OrderType.PRE_ORDER, paymentStatus: PaymentStatus.PAID, subtotal: 169, tax: 8, discount: 0, total: 177, createdAt: '2026-05-13T12:00:00Z', updatedAt: '2026-05-13T12:30:00Z', pickupDate: '2026-05-13' },
  { id: 'ord-6', orderNumber: 'RB-1006', userId: 'user-5', customerName: 'Karan Mehta', stallId: 'stall-4', stallName: 'Chai & More', items: [makeItem('oi-9','meal-10','Samosa (2 pcs)',3,39), makeItem('oi-10','meal-12','Masala Chai',3,29)], status: OrderStatus.PICKED_UP, orderType: OrderType.ON_STALL, paymentStatus: PaymentStatus.PAID, subtotal: 204, tax: 10, discount: 0, total: 214, createdAt: '2026-05-14T07:30:00Z', updatedAt: '2026-05-14T07:50:00Z', pickupDate: '2026-05-14' },
  { id: 'ord-7', orderNumber: 'RB-1007', userId: 'user-6', customerName: 'Ananya Singh', stallId: 'stall-1', stallName: 'RollBowl Main Kitchen', items: [makeItem('oi-11','meal-13','Veg Combo Meal',1,139)], status: OrderStatus.PENDING, orderType: OrderType.PRE_ORDER, paymentStatus: PaymentStatus.PENDING, subtotal: 139, tax: 7, discount: 0, total: 146, createdAt: '2026-05-14T10:10:00Z', updatedAt: '2026-05-14T10:10:00Z', pickupDate: '2026-05-14' },
];
