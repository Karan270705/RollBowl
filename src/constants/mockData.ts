import { MealCategory, MealType, NotificationType, OrderStatus, OrderType, PaymentMethod, PaymentStatus, PaymentVerificationStatus, SubscriptionStatus, UserRole } from './enums';
...
export const MOCK_MEALS: Meal[] = [
  { id: 'meal-1', name: 'Paneer Tikka Bowl', description: 'Grilled paneer with quinoa, fresh veggies, and mint chutney.', price: 149, originalPrice: 199, category: MealCategory.BOWL, type: MealType.VEG, stallId: 'stall-1', imageUrl: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=400', isAvailable: true, isFeatured: true, rating: 4.6, totalRatings: 89, preparationTime: 15, nutrition: { calories: 420, protein: '22g', carbs: '45g', fat: '12g' }, tags: ['Bestseller', 'Healthy'] },
  { id: 'meal-2', name: 'Chicken Shawarma Roll', description: 'Tender chicken wrapped in rumali roti with garlic sauce.', price: 129, category: MealCategory.BOWL, type: MealType.NON_VEG, stallId: 'stall-1', imageUrl: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=400', isAvailable: true, isFeatured: true, rating: 4.8, totalRatings: 156, preparationTime: 12, nutrition: { calories: 380, protein: '28g', carbs: '35g', fat: '14g' }, tags: ['Popular'] },
  ...
  { id: 'meal-4', name: 'Vegan Buddha Bowl', description: 'Brown rice, roasted chickpeas, avocado, and tahini dressing.', price: 169, category: MealCategory.BOWL, type: MealType.VEGAN, stallId: 'stall-3', imageUrl: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400', isAvailable: true, isFeatured: true, rating: 4.7, totalRatings: 67, preparationTime: 15, nutrition: { calories: 350, protein: '14g', carbs: '48g', fat: '10g' }, tags: ['Vegan', 'Healthy'] },
  ...
  { id: 'meal-6', name: 'Rajma Chawal Combo', description: 'North Indian rajma with steamed rice and salad.', price: 109, category: MealCategory.BOWL, type: MealType.VEG, stallId: 'stall-1', imageUrl: 'https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=400', isAvailable: true, isFeatured: false, rating: 4.5, totalRatings: 178, preparationTime: 12, tags: ['Comfort Food'] },
  ...
  { id: 'meal-10', name: 'Samosa (2 pcs)', description: 'Crispy samosas with mint and tamarind chutney.', price: 39, category: MealCategory.ROLL, type: MealType.VEG, stallId: 'stall-4', imageUrl: 'https://images.unsplash.com/photo-1601050690597-df0568f70950?w=400', isAvailable: true, isFeatured: false, rating: 4.2, totalRatings: 320, preparationTime: 5, tags: ['Quick', 'Classic'] },
  ...
  { id: 'meal-13', name: 'Veg Combo Meal', description: 'Roti, paneer curry, dal, rice, and gulab jamun.', price: 139, originalPrice: 169, category: MealCategory.COMBO, type: MealType.VEG, stallId: 'stall-1', imageUrl: 'https://images.unsplash.com/photo-1567337710282-00832b415979?w=400', isAvailable: true, isFeatured: false, rating: 4.5, totalRatings: 134, preparationTime: 18, tags: ['Value', 'Combo'] },
...
export const MOCK_ORDERS: Order[] = [
  { id: 'ord-1', orderNumber: 'RB-1001', userId: 'user-1', customerName: 'Rohan Sharma', stallId: 'stall-1', stallName: 'RollBowl Main Kitchen', items: [makeItem('oi-1','meal-1','Paneer Tikka Bowl',1,149), makeItem('oi-2','meal-7','Cold Coffee',2,69)], status: OrderStatus.PREPARING, orderType: OrderType.PRE_ORDER, paymentStatus: PaymentStatus.PAID, paymentMethod: PaymentMethod.UPI, paymentVerificationStatus: PaymentVerificationStatus.VERIFIED, subtotal: 287, tax: 14, discount: 0, total: 301, createdAt: '2026-05-14T09:30:00Z', updatedAt: '2026-05-14T09:35:00Z', estimatedReadyTime: '2026-05-14T09:50:00Z', pickupDate: '2026-05-14' },
  { id: 'ord-2', orderNumber: 'RB-1002', userId: 'user-2', customerName: 'Priya Patel', stallId: 'stall-1', stallName: 'RollBowl Main Kitchen', items: [makeItem('oi-3','meal-11','Thali Meal',2,159)], status: OrderStatus.PENDING, orderType: OrderType.ON_STALL, paymentStatus: PaymentStatus.PENDING, paymentMethod: PaymentMethod.CASH, paymentVerificationStatus: PaymentVerificationStatus.NOT_REQUIRED, subtotal: 318, tax: 16, discount: 20, total: 314, createdAt: '2026-05-14T09:40:00Z', updatedAt: '2026-05-14T09:40:00Z', pickupDate: '2026-05-14' },
  { id: 'ord-3', orderNumber: 'RB-1003', userId: 'user-3', customerName: 'Amit Kumar', stallId: 'stall-2', stallName: 'Campus Bites', items: [makeItem('oi-4','meal-3','Masala Dosa',1,89), makeItem('oi-5','meal-5','Egg Bhurji Pav',1,79)], status: OrderStatus.READY, orderType: OrderType.PRE_ORDER, paymentStatus: PaymentStatus.PAID, paymentMethod: PaymentMethod.CASH, paymentVerificationStatus: PaymentVerificationStatus.NOT_REQUIRED, subtotal: 168, tax: 8, discount: 0, total: 176, createdAt: '2026-05-14T08:15:00Z', updatedAt: '2026-05-14T08:40:00Z', pickupDate: '2026-05-14' },
  { id: 'ord-4', orderNumber: 'RB-1004', userId: 'user-4', customerName: 'Sneha Desai', stallId: 'stall-1', stallName: 'RollBowl Main Kitchen', items: [makeItem('oi-6','meal-2','Chicken Shawarma Roll',2,129), makeItem('oi-7','meal-12','Masala Chai',2,29)], status: OrderStatus.CONFIRMED, orderType: OrderType.SUBSCRIPTION, paymentStatus: PaymentStatus.PAID, paymentMethod: PaymentMethod.UPI, paymentVerificationStatus: PaymentVerificationStatus.VERIFIED, subtotal: 316, tax: 16, discount: 50, total: 282, createdAt: '2026-05-14T10:00:00Z', updatedAt: '2026-05-14T10:02:00Z', pickupDate: '2026-05-14' },
  { id: 'ord-5', orderNumber: 'RB-1005', userId: 'user-1', customerName: 'Rohan Sharma', stallId: 'stall-3', stallName: 'Green Bowl Express', items: [makeItem('oi-8','meal-4','Vegan Buddha Bowl',1,169)], status: OrderStatus.PICKED_UP, orderType: OrderType.PRE_ORDER, paymentStatus: PaymentStatus.PAID, paymentMethod: PaymentMethod.UPI, paymentVerificationStatus: PaymentVerificationStatus.VERIFIED, subtotal: 169, tax: 8, discount: 0, total: 177, createdAt: '2026-05-13T12:00:00Z', updatedAt: '2026-05-13T12:30:00Z', pickupDate: '2026-05-13' },
  { id: 'ord-6', orderNumber: 'RB-1006', userId: 'user-5', customerName: 'Karan Mehta', stallId: 'stall-4', stallName: 'Chai & More', items: [makeItem('oi-9','meal-10','Samosa (2 pcs)',3,39), makeItem('oi-10','meal-12','Masala Chai',3,29)], status: OrderStatus.PICKED_UP, orderType: OrderType.ON_STALL, paymentStatus: PaymentStatus.PAID, paymentMethod: PaymentMethod.UPI, paymentVerificationStatus: PaymentVerificationStatus.VERIFIED, subtotal: 204, tax: 10, discount: 0, total: 214, createdAt: '2026-05-14T07:30:00Z', updatedAt: '2026-05-14T07:50:00Z', pickupDate: '2026-05-14' },
  { id: 'ord-7', orderNumber: 'RB-1007', userId: 'user-6', customerName: 'Ananya Singh', stallId: 'stall-1', stallName: 'RollBowl Main Kitchen', items: [makeItem('oi-11','meal-13','Veg Combo Meal',1,139)], status: OrderStatus.PENDING, orderType: OrderType.PRE_ORDER, paymentStatus: PaymentStatus.PENDING, paymentMethod: PaymentMethod.CASH, paymentVerificationStatus: PaymentVerificationStatus.NOT_REQUIRED, subtotal: 139, tax: 7, discount: 0, total: 146, createdAt: '2026-05-14T10:10:00Z', updatedAt: '2026-05-14T10:10:00Z', pickupDate: '2026-05-14' },
];

// ─── Subscriptions ───────────────────────────────────────
// FALLBACK DATA ONLY: Production should always fetch active plans from the database.
export const MOCK_PLANS: SubscriptionPlan[] = [
  { id: 'dev-plan-1', name: 'Solo Plan', description: 'Choose any ONE item from the daily menu (per day)', price: 1200.00, durationDays: 25, mealsPerDay: 1, totalMeals: 20, features: ['1 Meal per day', 'Eligible: Rolls & Bowls', '25 Days Validity'], isPopular: true, badge: '20 MEALS', categoryCreditCosts: { roll: 1, bowl: 1 } },
  { id: 'dev-plan-2', name: 'Plus Plan', description: 'Choose any TWO items from the daily menu (per day)', price: 2099.00, durationDays: 25, mealsPerDay: 2, totalMeals: 20, features: ['2 Meals per day', 'Eligible: Rolls, Bowls, Combos', '25 Days Validity'], isPopular: false, badge: '20 MEALS', categoryCreditCosts: { roll: 1, bowl: 1, combo: 2 } },
];

export const MOCK_SUBSCRIPTION: Subscription = {
  id: 'sub-1', userId: 'user-1', planId: 'dev-plan-1', planName: 'Solo Plan',
  status: SubscriptionStatus.ACTIVE, startDate: '2026-05-01', endDate: '2026-05-31',
  totalMeals: 20, consumedMeals: 8, remainingMeals: 12, mealsPerDay: 1,
  extendedDays: 0, dailyCreditsUsed: 0,
};

export const MOCK_MEAL_HISTORY: MealHistory[] = [
  { id: 'mh-1', subscriptionId: 'sub-1', mealName: 'Paneer Tikka Bowl', date: '2026-05-14', time: '12:30 PM', category: MealCategory.BOWL },
  ...
  { id: 'mh-4', subscriptionId: 'sub-1', mealName: 'Rajma Chawal Combo', date: '2026-05-13', time: '1:00 PM', category: MealCategory.BOWL },
  { id: 'mh-5', subscriptionId: 'sub-1', mealName: 'Veg Combo Meal', date: '2026-05-12', time: '12:45 PM', category: MealCategory.BOWL },
];
...
export const MOCK_INVENTORY: InventoryItem[] = [
  { id: 'inv-1', mealId: 'meal-1', mealName: 'Paneer Tikka Bowl', stallId: 'stall-1', category: MealCategory.BOWL, totalQuantity: 50, soldQuantity: 32, reservedQuantity: 8, availableQuantity: 10, price: 149, isAvailable: true },
  { id: 'inv-2', mealId: 'meal-2', mealName: 'Chicken Shawarma Roll', stallId: 'stall-1', category: MealCategory.BOWL, totalQuantity: 40, soldQuantity: 28, reservedQuantity: 5, availableQuantity: 7, price: 129, isAvailable: true },
  { id: 'inv-3', mealId: 'meal-6', mealName: 'Rajma Chawal Combo', stallId: 'stall-1', category: MealCategory.BOWL, totalQuantity: 60, soldQuantity: 45, reservedQuantity: 10, availableQuantity: 5, price: 109, isAvailable: true },
  ...
  { id: 'inv-5', mealId: 'meal-13', mealName: 'Veg Combo Meal', stallId: 'stall-1', category: MealCategory.COMBO, totalQuantity: 30, soldQuantity: 30, reservedQuantity: 0, availableQuantity: 0, price: 139, isAvailable: false },
